...
const AuthForm = ({ onSubmit, isSignUp }) => {
    ...
    const handleSubmission = () => {
        const loginObject = { email, password, rememberMe };
        const registrationObject = { name, email, password };

        if (isPrivacyPolicyAgreed && isSignUp) {
            onSubmit(registrationObject);
        }
        else if (!isSignUp) {
    ...
    return (
        <form className="sign__form">
            ...
            {
                isSignUp && <div className='sign__group'>
                    <input
                        type="text"
...

            {
                ...
                <div className="sign__group sign__group--checkbox">
                    <input
                        ...
                        onChange={() => setIsPrivacyPolicyAgreed(prev => !prev)} />
                    <label
                        for="remember">
                        I agree to the
